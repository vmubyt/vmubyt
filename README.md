...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=html,css,tailwind,react,js,py,discordjs,nodejs,mysql,supabase" />
  </a>
</p>
...
- Fetch all information from website to Discord. (Automation)
- Realtime guessing games with leaderboard
- Auto moderation (anti-toxic)
- Twitter to Discord webhook system
- Giveaway and point system
...
- Fast embed update when answer is correct
- Multi-user support
...
- Realtime updates from multiple sources
